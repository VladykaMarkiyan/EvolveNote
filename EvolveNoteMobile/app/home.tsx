  ...
  return (
    <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.goalCard}>
          <View style={styles.goalContent}>
            ...
            <View style={styles.goalActions}>
              ...
              <View style={styles.action}><Text>📅</Text></View>
              <View style={[styles.action, styles.actionActive]}><Text style={{color:'#fff'}}>📄</Text></View>
            </View>
          </View>
        </View>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navBtn}><Image source={require('../assets/calend-g.png')} style={styles.navIcon} /></TouchableOpacity>
